...
export class PythonResolver implements ImportResolver {
     ...
     */
    private resolveRelativeImport(importStr: string, currentFile: string, allFiles: Set<string>): string | null {
        // 计算 . 的数量
     ...
     */
    private resolveAbsoluteImport(importStr: string, currentFile: string, allFiles: Set<string>): string | null {
        // 归一化: my.pkg -> my/pkg
