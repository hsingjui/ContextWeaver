...
import type { ProcessedChunk, ChunkMetadata, Window, SplitterConfig } from "./types.js";
...
export class SemanticSplitter {
    ...
    private windowsToChunks(
        ...
        for (let i = 0; i < windows.length; i++) {
            ...
            const codeEndIndex = this.adapter.getDomain() === 'utf8'
 ...
 * 生成向量化文本（包含面包屑上下文）
 */
export function generateVectorText(code: string, contextPath: string[]): string {
